      ...
      if (status) {
         ...
         const staticFoodQuestion = [
            ...
            },
            {
               contentIndex: 0,
               quizClueImage: "",
               quizClueText: "Buah terkenal dari medan tersebut adalah Durian",
               quizCorrectOption: 1,
               quizImage:
               ...
               quizReason: "Buah terkenal dari medan tersebut adalah Durian",
               quizSettingTimer: { timer: 10, pointSecond: 1 },
               tagImage: 1,
            },
            {
         ...
         runtime.callFunction("setProcess", "Terjadi kesalahan pada Server!");
      }
   });
}
...
function initGameQuiz() {
   ...
   runtime.callFunction(
      ...
      optionC,
      optionD,
      currentQuestion.quizClueText == null ? "" : currentQuestion.quizClueText,
      currentQuestion.quizClueImage == null ? "" : currentQuestion.quizClueImage
   );
   ...
   if (currentQuestion.quizReason == null || currentQuestion.quizReason == "") {
